    ...
    public partial class CoreEnvelopeDesignManageForm : Form
    {
        ...
        private void SettingPageData()
        {
            ...
            if (data != null)
            {
                ...
                //重心包线图
                DisplayInPicture(lstCorePt, zedGraphControlCore);
            }
        ...
        public static void DisplayInPicture(List<CorePointData> lstCorePt, ZedGraphControl zedGraphControlCore)
        {
            GraphPane myPane = zedGraphControlCore.GraphPane;
        ...
        private void gridCoreEnvelope_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //绑定图形
            DisplayInPicture(lstCurrentData, zedGraphControlCore);
        }
            ...
            if (fileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                if (treeCoreEnvelope.Nodes.Count > 0)
                {
                    ...
                    if (result == DialogResult.OK)
                    {
                        ...
                        //重心包线图
                        DisplayInPicture(lstCorePointData, zedGraphControlCore);
