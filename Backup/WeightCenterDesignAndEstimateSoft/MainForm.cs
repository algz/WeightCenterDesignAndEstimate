    ...
    public partial class MainForm : Form
    {
        ...
        private List<Model.CoreEnvelopeCutResultData> GetCoreEnvelopteCutData(XmlDocument doc)
        {
            ...
            foreach (XmlNode cutNode in cutNodeList)
            {
                ...
                {
                    if (setNodeList.Count == 4)
                    {
                        cutData.nDiscreteCircularPtCount = Convert.ToInt32(setNodeList[0].InnerText);
                        cutData.nDiscreteRadialPtCount = Convert.ToInt32(setNodeList[1].InnerText);
                        cutData.fDiscreteRadialFirstLen = Convert.ToDouble(setNodeList[2].InnerText);
                        cutData.fDiscreteRadialRatio = Convert.ToDouble(setNodeList[3].InnerText);
                    }
                }
        ...
        private void DisplayInPicture(DataTable table, ZedGraphControl zedGraphControlCore)
        {
            ...
            AddMyCurve(zedGraphControlCore, Color.Black, table, SymbolType.Default, "剪裁重心包线");
        ...
        private void DisplayCompareInPicture(CoreEnvelopeCutResultData cutData, ZedGraphControl zedGraphControlCore)
        {
            ...
            AddMyCurve(zedGraphControlCore, Color.Blue, tableBasic, SymbolType.Diamond, "原始重心包线");
            AddMyCurve(zedGraphControlCore, Color.Red, tableCut, SymbolType.Square, "剪裁重心包线");
        ...
        private void AddMyCurve(ZedGraphControl zedGraphControlCore, Color color, DataTable table, SymbolType symbolType, string strLable)
        {
            GraphPane myPane = zedGraphControlCore.GraphPane;
        ...
        {
            BasicDBSetForm form = new BasicDBSetForm();
            form.ShowDialog();
        }
